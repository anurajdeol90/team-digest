...
def main() -> int:
    ...
    ap.add_argument("--start", type=lambda s: dt.date.fromisoformat(s))
    ap.add_argument("--end", type=lambda s: dt.date.fromisoformat(s))
    ...
    start = a.start or (end - dt.timedelta(days=6))
